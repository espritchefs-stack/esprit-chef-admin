...
const resources = {
  en: {
    translation: {
      ...
      "signature_label": "ESPRIT SIGNATURE",
      "classes_label": "CLASSES",
      "my_class_label": "MY CLASS",
      "nothing_featured": "NOTHING FEATURED YET",
      "back": "BACK",
      "chefs_note_label": "CHEF'S NOTE",
      "member_login": "MEMBER LOGIN",
      "offline_access": "OFFLINE STUDENT ACCESS",
      "sign_in": "SIGN IN",
      "sign_up": "SIGN UP",
      "google_continue": "CONTINUE WITH GOOGLE",
      "loading_recipe": "LOADING RECIPE...",
      "header_subtitle": "CHEF · COOKING ACADEMY",
      "search_recipes": "Search {{count}} recipes",
      "show_all": "Show all {{count}} ∨",
      "collapse": "Collapse ∧",
      "no_results": "No results for \"{{query}}\"",
      "kakao_consult": "Consult via KakaoTalk",
  ...
  ko: {
    translation: {
      ...
      "category_foundation": "기초반",
      "category_intermediate": "중급반",
      "category_professional": "전문반",
      "category_banchan": "한식반찬",
      "signature_label": "에스프릿 시그니처",
      "classes_label": "클래스 안내",
      "my_class_label": "내 수업",
      "nothing_featured": "아직 시그니처 요리가 준비되지 않았습니다",
      "back": "뒤로",
      "chefs_note_label": "셰프 노트",
      "member_login": "회원 로그인",
      "offline_access": "수강생 코드 입장",
      "sign_in": "로그인",
      "sign_up": "회원가입",
      "google_continue": "Google로 계속하기",
      "loading_recipe": "레시피를 불러오는 중...",
      "header_subtitle": "에스프릿셰프 쿠킹 아카데미",
      "search_recipes": "레시피 검색 (전체 {{count}}개)",
      "show_all": "전체 {{count}}개 보기 ∨",
      "collapse": "접기 ∧",
      "no_results": "\"{{query}}\" 검색 결과가 없습니다",
      "kakao_consult": "카카오톡으로 상담하기",
